//ghost 默认的请求数据
var defaultReqData = {"ghost_version":"0.5.0","node_version":"0.10.28","env":"development","database_type":"sqlite3","blog_id":"adaad76294f5d22e37a7faa444c16311","theme":"casper","apps":"","post_count":1,"user_count":0,"blog_created_at":"","npm_version":"1.4.9"};
...
router.get('/', function(req, res) {
    //保存当前请求的信息
   var reqData = defaultReqData;
    reqData.req_date = new Date();
    reqData.headers = JSON.stringify(req.headers);
    reqData.ip = req._remoteAddress;
